...
with open(r"/home/chengxiao/project/vul_detect/resources/sensiAPI.txt",
          "r") as f:
    a = f.read().split(',')
...
if __name__ == '__main__':
    test_gadget = [
        ...
        'while ((c = getopt(argc, argv, "k:s:m:o:h")) != -1) {', 'switch(c) {'
    ]

    test_gadget2 = [
        '278 151587/ffmpeg.c inputfunc 3159', 'int main(int argc,char **argv)',
        'parse_loglevel(argc,argv,options);',
        'if (argc > 1 && !strcmp(argv[1],"-d")) {', 'argc--;', 'argv++;',
