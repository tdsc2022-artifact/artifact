...
class VDPDataModule(LightningDataModule):
    ...
    def create_dataloader(
        ...
        dataset = VDPDataset(path, seq_len, shuffle)
    ...
    def transfer_batch_to_device(self, batch: VDPBatch,
                                 device: torch.device) -> VDPBatch:
