'''codegadget generator

backward and forward slicing data-flow related statements
'''

from utils.svf_parser import buildCFGNodeToLineDict, getCFGsEntryLineToNode, buildSVFGNodeToLineDict, locateLineEntry, extractOperatorLines, buildCallGraphDict, extractAPILines, dfs_pred_lines, getCallChainList
    ...
    for root, testcaseIDList, files in os.walk(dot_root_dir):
        ...
        for testcaseID in testcaseIDList:
            ...
            for dot_dir in os.listdir(dotRoot):
                ...
                svfgPath = join(dotRoot, dot_dir, "svfg_final.dot")
                cfgPath = join(dotRoot, dot_dir,"icfg_final.dot")
                callgPath = join(dotRoot, dot_dir, "callgraph_final.dot")
